...
public class HomePageScooter {
    ...
    private By orderInFooterButton = By.className("Button_Button__ra12g");
    private By answers = By.xpath(".//div[@class='accordion__panel']//*");
    private By textAboutImportantField = By.xpath(".//div[@class='accordion__panel']//*");
    private By headerAboutImportantField = By.className("Home_FourPart__1uthg");
    public static By orderInBodyButton = By.xpath("//div[@class='Home_FinishButton__1_cWm']/button");
